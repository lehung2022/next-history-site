  ...
  return (
    <div className="flex flex-col items-center text-gray-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 w-full max-w-5xl px-4">
        <Link href="/timelines/vietnam-timelines" className="group">
        ...
        <Link href="/timelines/japan-timelines" className="group">
        ...
        <Link href="/timelines/china-timelines" className="group">
