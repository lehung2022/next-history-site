    ...
    <div className="flex flex-col items-center text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 w-full max-w-5xl px-4 ">
        <Link href="/dynasties/trieu-dai-viet-nam" className="group">
          <div className="relative w-full h-48 border-2 border-white rounded-lg bg-amber-300">
            <Image
        ...
        <Link href="/dynasties/japan-period" className="group">
          <div className="relative w-full h-48 border-2 border-white rounded-lg bg-amber-50">
            <Image
        ...
        <Link href="/dynasties/zung-gwok-ciu-doi" className="group">
          <div className="relative w-full h-48 border-2 border-white rounded-lg bg-red-600">
            <Image
      ...
      <Link
        href="/"
        className="text-white mt-4 bg-slate-950/50 hover:bg-slate-950 px-4 py-2 rounded-lg mb-4"
      >
        ← Back
      </Link>
    </div>
