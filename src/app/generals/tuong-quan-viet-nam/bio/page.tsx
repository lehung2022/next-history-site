...
const vietGenerals = [
  {
    name: "Đinh Bộ Lĩnh",
    image: "/vietnamese_generals/dinh_bo_linh.jpg",
  ...
  {
    name: "Dương Tam Kha",
    image: "/vietnamese_generals/duong_tam_kha.jpg",
...
const GeneralBio = async ({
  ...
  // Await searchParams và lấy giá trị general
  const { general: generalParam } = await searchParams;
    ...
    <div className="flex flex-col items-center text-gray-200">
      ...
      <div className="w-full max-w-5xl px-4">
        <div className="flex flex-col items-center">
          <div className="relative w-full h-96 border-2 border-white rounded-lg bg-amber-300">
            <img
              src={general.image}
              alt={general.name}
